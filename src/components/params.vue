<template>
  <div class="my-params">
    <!-- 面包屑 -->
    <my-break sectitle="商品管理" thirdtitle="分类参数"></my-break>
    <!-- 警告提示 -->
    <el-alert class="my-alert" title="注意:只允许为第三集分类设置相关参数" type="warning" show-icon></el-alert>
    <!-- 级联选择 -->
    <el-row class="my-row">
      <el-col span="24">
        <span>请选择商品分类: &nbsp;&nbsp;</span>
    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="动态参数" name="first">
        <!-- 按钮 -->
        <el-button class="my-btn" size="mini" type="primary">添加动态参数</el-button>
        <!-- 表格 -->
      ...
      <el-tab-pane label="静态参数" name="second">
        <!-- 按钮 -->
        <el-button class="my-btn" size="mini" type="primary" disabled>添加静态参数</el-button>
        <!-- 表格 -->
        <el-table :data="staticlist" style="width: 100%" border>
          <el-table-column type="index" width="50"></el-table-column>
          <el-table-column prop="username" label="属性名称" width="180"></el-table-column>
          <el-table-column prop="email" label="属性值" width="180"></el-table-column>
          <el-table-column label="操作">
            <!-- scope 是一个名字 -->
            <template slot-scope="scope">
              <!-- 我们可以通过scope.$index 获取索引 scope.row获取这一行的数据 -->
